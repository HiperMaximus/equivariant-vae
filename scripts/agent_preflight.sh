...
required_files=(
  ...
  "docs/data/spec0011_runtime_recipe_v2/evidence_manifest.json"
  "docs/data/spec0011_runtime_recipe_v2/runtime_recipe_bakeoff.csv"
  "docs/data/spec0011_runtime_recipe_v2/runtime_inventory.json"
  "docs/data/spec0011_runtime_recipe_v2/runtime_option_coverage.json"
  "docs/data/spec0011_runtime_recipe_v2/runtime_recipe_checkpoint.json"
  "docs/data/spec0011_runtime_recipe_v2/producer/run.py"
  ...
  "docs/decisions/0003-overleaf-subtree-and-tracked-pdf.md"
