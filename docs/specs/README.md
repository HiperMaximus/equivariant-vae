...
| `0016-so2-real-data-prelaunch-and-full-run.md` | Locked; fresh-resource session 6 verifies update 54000 and all 13 manifest hashes. Retain session-4 67/68, session-5 66/68, and session-6 66/68 caveats; session 6 has one and five saturated-open channels in its two failed rows. | Obtain explicit acceptance of the session-6 deterioration, then stage only exact step 54000 for a separately authorized final continuation. | Do not weaken the caveat or infer update 60000 before proof verifies. |
