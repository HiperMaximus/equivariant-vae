...
| `0016-so2-real-data-prelaunch-and-full-run.md` | Locked; session 5 verifies update 45000 with retained 67/68 and accepted 66/68 caveats. Session-6 v3-v5 fail on old resource `131085532`; fresh controls pass, and fresh full-kernel version 1 is submitted. | Wait for the fresh kernel to settle, then download and verify its proof/manifest. | Do not infer the next checkpoint before its proof and manifest verify. |
