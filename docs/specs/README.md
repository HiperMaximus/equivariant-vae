...
Runtime-selection version 4 is running that follow-up remotely; it can replace
v3 only if a policy is materially faster and does not trigger catastrophic
failures.
