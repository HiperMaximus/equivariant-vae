...
| `0016-so2-real-data-prelaunch-and-full-run.md` | Locked / prelaunch passed / full sessions 1-2 committed through update 18000. | Resume only from the downloaded hash-pinned SO2 checkpoint; preserve the passed execution core. | Verify and launch the authorized checkpoint-only session-3 transport. |
