...
| `0016-so2-real-data-prelaunch-and-full-run.md` | Locked / prelaunch passed / full session 1 committed through update 9000. | Resume only from the downloaded hash-pinned SO2 checkpoint; preserve the passed execution core. | Finish the guarded checkpoint-only session-2 transport, then launch under the user's approval. |
