...
| `0016-so2-real-data-prelaunch-and-full-run.md` | Locked; session 6 verifies update 54000/all 13 hashes. Its 66/68 result with one and five saturated-open channels is accepted; private 54k dataset version 1 verifies, and final kernel version 2 is submitted. | Wait for terminal state, then download and verify update-60000 proof/manifest. | Do not weaken the caveat or infer update 60000 before proof verifies. |
