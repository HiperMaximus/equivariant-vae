...
| `0013-fixed-f01-architecture-probe.md` | Local mechanics and the reviewed three-arm v2 follow-up pass locally; dual-T4 v1 from `e57f086` transferred the selected runtime cleanly but failed the 10% expansion/assembly gate at 40.7–41.3%. | Dual-T4 v2 candidate selection, then singularization and passing full acceptance. | Obtain fresh permission before Kaggle v2; do not assemble the full VAE. |
