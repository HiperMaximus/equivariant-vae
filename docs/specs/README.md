...
That selected row is the safety baseline for debug/full-run planning. Before a
60h+ run, run an efficiency follow-up that can replace it if AMP/FP16, stable
`torch.compile`, or historical FSQ efficiency flags are materially faster and
